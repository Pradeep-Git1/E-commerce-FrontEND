...
const appColors = {
  ...
  lightText: "#666", // Example light text color
...
const CheckoutModal = ({ combinedCart, checkoutModalVisible, handleCloseCheckoutModal, calculateTotal, getImageSrc }) => {
  ...
  const handleAddressChange = (value) => setSelectedAddress(value);
  ...
  const handleProceedToPayments = () => {
    message.success(`Payment option selected: ${paymentOption}`);
    ...
    >
      <div>
        ...
        <div style={{ marginTop: '16px' }}>
          ...
          <Form layout="vertical" size="small"> {/* Reduced form size */}
