...
// Generate 30 white chocolate products
const products = Array.from({ length: 30 }, (_, i) => ({
  id: i + 1,
  name: `White Chocolate ${i + 1}`,
...
const WhiteChocolates = () => {
  return (
    <div className="container mt-5">
      <Title level={2} className="text-center text-dark">🍫 White Chocolates</Title>
      <div className="row">
...
export default WhiteChocolates;
